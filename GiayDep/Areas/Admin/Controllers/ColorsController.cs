...
namespace GiayDep.Areas.Admin.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public ColorsController(GiaydepContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Color != null ? 
                          ...
                          Problem("Entity set 'GiaydepContext.Color'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Color1,ColorHex")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Color1,ColorHex")] Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GiaydepContext.Color'  is null.");
            }
            var color = await _context.Color.FindAsync(id);
            if (color != null)
            {
