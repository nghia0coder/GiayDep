...
namespace GiayDep.Areas.Admin.Controllers
{
    ...
    public class MembershipsController : Controller
    {
        ...
        public MembershipsController(GiaydepContext context)
        {
            _context = context;
        }
        ...
        {
            var giaydepContext = _context.Memberships.Include(m => m.MaLoaiTvNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GiaydepContext.Memberships'  is null.");
            }
            var membership = await _context.Memberships.FindAsync(id);
            if (membership != null)
            {
