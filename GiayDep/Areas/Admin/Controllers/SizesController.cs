...
namespace GiayDep.Areas.Admin.Controllers
{
    ...
    public class SizesController : Controller
    {
        ...
        public SizesController(GiaydepContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Sizes != null ? 
                          ...
                          Problem("Entity set 'GiaydepContext.Sizes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Size1")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Size1")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GiaydepContext.Sizes'  is null.");
            }
            var size = await _context.Sizes.FindAsync(id);
            if (size != null)
            {
