...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdchitietDdh).HasName("PK_CT_HOA_DON_1");
            ...
            entity.HasOne(d => d.IdspNavigation).WithMany(p => p.CtHoaDons)
        ...
        {
            entity.HasKey(e => e.IdchitietPn).HasName("PK_CT_PHIEU_NHAP_1");
            ...
            entity.HasOne(d => d.IdphieunhapNavigation).WithMany(p => p.CtPhieuNhaps)
                .HasForeignKey(d => d.Idphieunhap)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CT_PHIEU_NHAP_PHIEU_NHAP");

            entity.HasOne(d => d.IdspNavigation).WithMany(p => p.CtPhieuNhaps)
                .HasForeignKey(d => d.Idsp)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<KhachHang>(entity =>
        {
            ...
            entity.HasOne(d => d.IdtvNavigation).WithMany(p => p.KhachHangs)
        ...
        modelBuilder.Entity<Membership>(entity =>
        {
            ...
            entity.HasOne(d => d.MaLoaiTvNavigation).WithMany(p => p.Memberships)
        ...
        {
            entity.HasKey(e => new { e.MaLoaiTv, e.Idright }).HasName("PK_Membership_right_1");
            ...
            entity.HasOne(d => d.IdrightNavigation).WithMany(p => p.MembershipRights)
                .HasForeignKey(d => d.Idright)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Membership_right_Right");

            entity.HasOne(d => d.MaLoaiTvNavigation).WithMany(p => p.MembershipRights)
                .HasForeignKey(d => d.MaLoaiTv)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<NhaCungCap>(entity =>
        {
            ...
            entity.HasOne(d => d.IdnhasxNavigation).WithMany(p => p.NhaCungCaps)
        ...
        modelBuilder.Entity<PhieuNhap>(entity =>
        {
            ...
            entity.HasOne(d => d.IdnhaccNavigation).WithMany(p => p.PhieuNhaps)
